...
jQuery(document).ready(function($){
	...
	// buttons
	$(document).on('click','.rte-wrap .rte-toolbar a',function(e){
		e.preventDefault();
	...
	// select
	$(document).on('change', '.rte-wrap .rte-toolbar select', function(e){
		var bool 	= false;
		var value 	= $(this).val();
	...
	// tab click
	$(document).on('click', 'ul.tabs span[alt^="#"]', function(e){
		e.preventDefault();
		var tabs = $(this).parents('ul.tabs').find('li');
		var tab_next = $(this).attr('alt');
		var tab_current = tabs.filter('.current').find('span').attr('alt');
		$(tab_current).hide();
	...
	/*---------------------------------
		Notice
	-----------------------------------*/
	$(document).on('click', '.notice a.close', function(e){
		e.preventDefault();
